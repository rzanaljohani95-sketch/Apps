(() => {
  ...
  const CYCLE_PHASES = {
    menstrual: {
      ...
      tips: [
        ...
        'تقلصات وتعب أول الدورة أمر طبيعي — استمعي لجسمك ولا تجبريه على شدة عالية.',
        'مع تقدّم الأيام تبدأ الطاقة بالتحسن تدريجيًا — زيدي النشاط بالتدريج حسب راحتك.',
      ],
    },
    follicular: {
      icon: '🌱', label: 'المرحلة الجريبية',
      tips: [
        'الطاقة ترتفع تدريجيًا — وقت مناسب لزيادة شدة التمارين تدريجيًا.',
        'جسمك يستعيد نشاطه بوضوح — فرصة جيدة لبدء هدف أو تمرين جديد.',
        'التركيز والحافز عادة أعلى هذه المرحلة — استغليها لتخطيط أسبوعك الرياضي.',
      ],
    },
    ovulation: {
      icon: '🥚', label: 'الإباضة',
      tips: [
        ...
        'قوتك وتحملك في أعلى مستوياتهما هذه الأيام — مناسبة لتحدي نفسك بتمرين أصعب من المعتاد.',
        'انتبهي لأي انزعاج خفيف حول يوم الإباضة، لكن نشاطك البدني عادة في قمته.',
      ],
    },
    luteal: {
      ...
      tips: [
        ...
        'مستوى الطاقة يبدأ بالانخفاض تدريجيًا — تمارين متوسطة الشدة قد تناسبك أكثر من المكثفة الآن.',
        'قرب موعد الدورة قد تلاحظين انتفاخ أو تقلب مزاج — هذا طبيعي وجزء متوقع من الدورة.',
      ],
    },
  };
  // A few variants per date-derived index so the same phase doesn't always
  // show the exact same sentence every time it comes around.
  function pickVariant(list, forDate, seed) {
    const dayNum = Number(forDate.slice(8, 10)) || 0;
    const monthNum = Number(forDate.slice(5, 7)) || 0;
    return list[(dayNum + monthNum + (seed || 0)) % list.length];
  }
  ...
  const CYCLE_PHASE_EXPECT = {
    menstrual: {
      body: [
        'تقلصات وتعب عام محتمل، وانتفاخ خفيف قد يستمر من المرحلة السابقة.',
        'شد أسفل البطن وربما ألم أسفل الظهر، خصوصًا بالأيام الأولى.',
      ],
      appetite: [
        'الشهية غالبًا طبيعية، وقد تزيد قليلًا في اليوم الأول أو الثاني.',
        'قد ترغبين بأطعمة معينة أكثر من المعتاد — استمعي لجسمك باعتدال.',
      ],
      intensity: [
        'تحمّل شدة التمرين ينخفض — قلّلي الحمل حسب راحتك، ولا بأس بالراحة.',
        'الأداء البدني أقل من المعتاد هذه الأيام — تمارين خفيفة كالمشي كافية.',
      ],
      sugar: [
        'الرغبة بالسكريات خفيفة إلى متوسطة عادة.',
        'قد تلاحظين رغبة أعلى قليلًا بالحلويات أول يومين.',
      ],
    },
    follicular: {
      body: [
        'الانتفاخ يخف بوضوح، والجسم يشعر بخفة ونشاط أكبر.',
        'البشرة والمزاج عادة يتحسنان ملحوظًا هذه المرحلة.',
      ],
      appetite: [
        'الشهية معتدلة ومستقرة نسبيًا.',
        'قد تحسّين بانخفاض طفيف بالشهية مقارنة بالأيام السابقة.',
      ],
      intensity: [
        'تحمّل شدة التمرين يتحسن تدريجيًا — وقت مناسب لزيادة الأحمال أو الشدة.',
        'القوة والتحمل بالارتفاع — فرصة جيدة لتمارين أصعب تدريجيًا.',
      ],
      sugar: [
        'الرغبة بالسكريات منخفضة نسبيًا.',
        'شهيتك للسكريات عادة هادئة هذه الفترة.',
      ],
    },
    ovulation: {
      body: [
        'ذروة النشاط والحيوية، وقد يظهر انتفاخ بسيط جدًا حول يوم الإباضة نفسه.',
        'قد تشعرين بألم خفيف جانبي بسيط حول يوم الإباضة — طبيعي وعادة يزول بسرعة.',
      ],
      appetite: [
        'الشهية عادة في أدنى مستوياتها خلال الشهر.',
        'شهية معتدلة إلى منخفضة هذه الأيام.',
      ],
      intensity: [
        'أعلى تحمّل لشدة التمرين — وقت جيد للتمارين عالية الكثافة إن رغبتِ.',
        'قوتك وسرعتك في ذروتهما — مناسب لتجربة تمرين أصعب من المعتاد.',
      ],
      sugar: [
        'الرغبة بالسكريات منخفضة عادة.',
        'شهيتك للحلويات هادئة هذه المرحلة غالبًا.',
      ],
    },
    luteal: {
      body: [
        'انتفاخ وحساسية بالثدي واردة، وزيادة طفيفة بالوزن قرب نهاية المرحلة بسبب احتباس الماء.',
        'قد تشعرين بثقل أو انتفاخ خفيف تدريجيًا كل ما اقترب موعد الدورة.',
      ],
      appetite: [
        'الشهية ترتفع تدريجيًا، خصوصًا بالأسبوع الأخير قبل الدورة.',
        'رغبة أعلى بالأكل عمومًا قرب نهاية هذه المرحلة — طبيعية وهرمونية.',
      ],
      intensity: [
        'تحمّل شدة التمرين يقل تدريجيًا — استمعي لجسمك وخففي إذا احتجتِ.',
        'الطاقة قد تتذبذب — يومًا نشيطًا ويومًا أهدأ، وكلاهما طبيعي.',
      ],
      sugar: [
        'الرغبة بالسكريات والكربوهيدرات ترتفع بشكل ملحوظ (من أعراض ما قبل الدورة الشائعة).',
        'شهية أعلى للحلويات والنشويات قرب موعد الدورة — أمر شائع جدًا.',
      ],
    },
  };
  ...
  function renderCycleCard() {
    ...
    const phaseTip = pickVariant(phaseInfo.tips, todayStr());
    const expect = CYCLE_PHASE_EXPECT[info.phase];
    const expectRows = CYCLE_EXPECT_ROWS.map((r, i) => `
      <div class="cycle-expect-row">
        ...
        <div class="cycle-expect-text">
          ...
          <span class="cycle-expect-desc">${pickVariant(expect[r.key], todayStr(), i + 1)}</span>
        </div>
      </div>
    `).join('');
